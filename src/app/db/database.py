...
CREATE TABLE IF NOT EXISTS leads (
    ...
    enrichment_score_delta INTEGER DEFAULT 0,
    enrichment_summary TEXT DEFAULT '',
    enrichment_data TEXT DEFAULT '{}',
    enrichment_full_name TEXT DEFAULT '',
    enrichment_company TEXT DEFAULT '',
    enrichment_title TEXT DEFAULT '',
    enrichment_location TEXT DEFAULT '',
    enrichment_profiles TEXT DEFAULT '[]',
    enriched_at TEXT,
