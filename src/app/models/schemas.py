...
class LeadResponse(BaseModel):
    ...
    enrichment_confidence: Optional[int] = 0
    enrichment_score_delta: Optional[int] = 0
    enrichment_summary: Optional[str] = ""
    enrichment_data: Optional[str] = "{}"
    enrichment_full_name: Optional[str] = ""
    enrichment_company: Optional[str] = ""
    enrichment_title: Optional[str] = ""
    enrichment_location: Optional[str] = ""
    enrichment_profiles: Optional[str] = "[]"
